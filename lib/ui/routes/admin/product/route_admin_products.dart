...
import 'package:total_pos/ui/routes/admin/product/widgets/table_products.dart';

class RouteAdminProduct extends ConsumerWidget {
  static const routeName = "admin.product";
  static const routePath = "/admin/product";
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            DialogCreateNewProduct.show(context)
                              ...
                              final (name, description, price) = response;
                              methods.createProduct(name, description, price);
                            });
                          },
